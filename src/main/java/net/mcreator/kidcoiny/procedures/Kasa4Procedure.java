...
public class Kasa4Procedure {
   public static void execute(LevelAccessor world, Entity entity) {
      if (entity instanceof Player player) {
         ...
         ItemStack diamondStack = new ItemStack(Items.SLIME_BLOCK);
         if (player.getInventory().contains(diamondStack)) {
            ...
            if (itemHandlerRef.get() != null) {
               ...
               for (int idx = 0; idx < itemHandler.getSlots(); idx++) {
                  ...
                  if (itemStackInSlot.getItem() == Items.SLIME_BLOCK) {
                  ...
                  if (amountOfItemNeeded >= 5.0D && !itemBought) {
                     ...
                     // Remove 1 DIAMOND from the player's inventory
                     removeItemFromPlayer(player, diamondStack, 5);
