...
public class Kasaaa4Procedure {
    ...
    public static void execute(LevelAccessor world, Entity entity) {
        if (entity instanceof Player player) {
            ...
            ItemStack goldIngotStack = new ItemStack(Items.CONDUIT);
            if (player.getInventory().contains(goldIngotStack)) {
                ...
                if (itemHandlerRef.get() != null) {
                    ...
                    for (int idx = 0; idx < itemHandler.getSlots(); idx++) {
                        ...
                        if (itemStackInSlot.getItem() == Items.CONDUIT) {
                        ...
                        if (amountOfItemNeeded >= 1.0D && !itemBought) {
                            ...
                            ItemStack newStack = new ItemStack(KidcoinyModItems.KIDCOIN_ZIELONY_SCRAP4.get(), 1);
