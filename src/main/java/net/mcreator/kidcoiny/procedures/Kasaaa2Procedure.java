...
public class Kasaaa2Procedure {
    ...
    public static void execute(LevelAccessor world, Entity entity) {
        if (entity instanceof Player player) {
            ...
            ItemStack goldIngotStack = new ItemStack(KidcoinyModItems.KIDCOIN_1000.get());
                ...
                if (itemHandlerRef.get() != null) {
                    ...
                    for (int idx = 0; idx < itemHandler.getSlots(); idx++) {
                        ...
                        if (amountOfItemNeeded >= 1.0D && !itemBought) {
                            ...
                            ItemStack newStack = new ItemStack(KidcoinyModItems.KIDCOIN_ZIELONY_SCRAP2.get(), 1);
