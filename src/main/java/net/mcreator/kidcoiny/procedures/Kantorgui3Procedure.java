...
public class Kantorgui3Procedure {
            ...
            if (itemHandlerRef.get() != null) {
               ...
               for (int idx = 0; idx < itemHandler.getSlots(); idx++) {
                  ...
                  if (amountOfItemNeeded >= 1.0D && !itemBought) {
                     ...
                     // Remove 1 KIDCOIN_10 from the player's inventory
                     removeItemFromPlayer(player, kidCoin10Stack, 1);

                     // Give the player 10 KIDCOIN_1 items
                     ItemStack newStack = new ItemStack(KidcoinyModItems.KIDCOIN_1.get(), 10);
